    ...
    <main>
      ...
      <section>
        <div className="w-full">
          <Image src="/ws-team.webp" alt="Group Image" layout="responsive" width={100} height={100} className="w-full h-auto" />
        </div>
      </section>
      ...
      <section>
        <div className="p-4">
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="w-full md:w-1/2">
              <Image src="/ws-homeDesktop.webp" alt="home" layout="responsive" width={100} height={100}  className="max-w-full h-auto mx-auto" />
            </div>
            <div className="w-full md:w-1/2">
        ...
        <div className="p-4">
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            ...
            <div className="w-full md:w-1/2">
              <Image src="/ws-project.webp" alt="home" layout="responsive" width={100} height={100} className="max-w-full h-auto mx-auto" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="flex flex-row justify-center items-center gap-4 p-4">
        <div>
          <Image src="/ws-iPad_Pro_2020.webp" alt="tab screen" layout="responsive" width={100} height={100} className="max-w-full h-auto" />
        </div>
        <div>
          <Image src="/ws-iPhone_13.webp" alt="phone screen" layout="responsive" width={100} height={100} className="max-w-full h-auto" />
        </div>
      </section>
